...
for comb in combinations:
    ...
    for protein in orthologs:
        f = open("temp.txt","w")
        for rec in SeqIO.parse("data/Arabidopsis_filtered.fa", "fasta"): #zrobic to optymalnie, przy robieniu slownika
            if rec.id == protein:
        ...
        f.close()
        os.system("mafft --auto --clustalout temp.txt > alignments/{}_{}-{}.txt".format(comb,comb[::-1],protein))
